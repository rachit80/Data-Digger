...
public class Words implements Runnable
{
	...
	public void run()
	{
        ...
        try 
        {
        	...
        	int t=0;
            ResultSet res = st.executeQuery("SELECT * FROM Words LIMIT "+num+",2 ");
            ...
            while (res.next()) //res initially point to NULL
            {
            	...
            	int value = res.getInt("w_value");
            	//System.out.println("initial"+msg+value);
            	...
            	while((line=bufferedReader.readLine())!=null) 
            	{
            		...
            		while(tokens.hasMoreTokens())
            		{
            			...
            			if(word.equalsIgnoreCase(msg))//for case insensitive matching
            			{
            				count++;
